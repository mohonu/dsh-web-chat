	...
	factory: (require) => {
		...
		*/
		...
		function WebChatPanel({ api, tt, sessions, workspaces, currentCwd }) {
			...
			const continuationTargets = sessionSnapshot.ids.map((id) => sessionSnapshot.byId[id]).filter((session) => session !== void 0 && session.blank !== true);
									...
									children: [
										...
										/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("select", {
											...
											children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)("option", {
												...
												value: session.id,
												children: [session.displayTitle, session.running === true ? " ·●" : ""]
											}, session.id))]
										}),
										/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("select", {
											className: panel_module_css_default.workspaceSelect,
